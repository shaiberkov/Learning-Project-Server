...
//    @Query("SELECT c.name FROM SchoolEntity s JOIN s.classRooms c WHERE s.schoolCode = :schoolCode")
//    List<String> getAllSchoolClassesName(@Param("schoolCode") String schoolCode);
//
