...
public class ComplexDivisionQuestion implements MathQuestion {
    ...
    public QuestionEntity generateQuestion(int difficulty) {
        ...
        return new QuestionEntity("מתמטיקה", "חילוק מספרים מרוכבים", questionText, answer);
    }
