...
public class ComplexDivisionQuestion implements QuestionGenerator {
    ...
    public QuestionEntity generateQuestion(int difficulty) {
        ...
        String answer = calculateComplexDivision(real1, imaginary1, real2, imaginary2, real3, imaginary3);
        System.out.println(questionText);
        System.out.println(answer);

        return new QuestionEntity("מתמטיקה", "מספרים מרוכבים" ,"חילוק מספרים מרוכבים", questionText, answer);
    }
    ...
    private String calculateComplexDivision(int real1, int imaginary1, int real2, int imaginary2, int real3, int imaginary3) {
        ...
        if (real3 != 0 || imaginary3 != 0) {
            int denominator3 = real3 * real3 + imaginary3 * imaginary3;
            int realPart3 = (realPart * real3 + imaginaryPart * imaginary3) / denominator3;
            int imaginaryPart3 = (imaginaryPart * real3 - realPart * imaginary3) / denominator3;
            realPart = realPart3;
