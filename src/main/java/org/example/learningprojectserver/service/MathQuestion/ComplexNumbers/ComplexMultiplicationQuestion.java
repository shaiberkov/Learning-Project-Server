...
public class ComplexMultiplicationQuestion implements QuestionGenerator {
    ...
    public QuestionEntity generateQuestion(int difficulty) {
        ...
        return new QuestionEntity("מתמטיקה","מספרים מרוכבים" , "כפל מספרים מרוכבים", questionText, answer);
    }
