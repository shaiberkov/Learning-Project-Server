...
public class ComplexSubtractionQuestion implements QuestionGenerator {
    ...
    public QuestionEntity generateQuestion(int difficulty) {
        ...
        return new QuestionEntity("מתמטיקה","מספרים מרוכבים" , "חיסור מספרים מרוכבים", questionText, answer);
    }
