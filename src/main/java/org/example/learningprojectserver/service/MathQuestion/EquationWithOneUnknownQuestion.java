...
public class EquationWithOneUnknownQuestion implements MathQuestion {
    ...
    public QuestionEntity generateQuestion(int difficulty) {
        ...
        boolean isMultiplication = random.nextBoolean(); // אם השאלה כוללת כפל עם X
        ...
        return new QuestionEntity("מתמטיקה", "מישוואה עם נעלם אחד", questionText, answer);
    }
