...
public class AllTeachersStrategy implements MessageRecipientStrategy {

    private final SchoolRepository schoolRepository;

    public AllTeachersStrategy(SchoolRepository schoolRepository) {
        this.schoolRepository = schoolRepository;
    }

    @Override
    public List<UserEntity> getRecipients(String senderId) {
        return schoolRepository.findTeachersByUserId(senderId);
    }
}